              ...
              <div className="flex items-center h-full space-x-8">
                ...
                <div className="relative flex-1">
                  <input
                    ...
                    className="pl-4 pr-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary w-full"
                  />
                  <IonIcon icon={searchOutline} className="absolute right-3 top-2.5 text-gray-400 w-5 h-5" />
                </div>
